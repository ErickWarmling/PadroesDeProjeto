...
import static controller.CardController.COLUMNS;
import static controller.CardController.ROWS;
...
public class Memory extends JFrame implements Observador {
	...
	public Memory() {
		...
		this.card.addObservadores(this);
	...
	@Override
	public void inicioJogo(int index, int r, int c) {
		ImageIcon tempImg = new ImageIcon("imagens/Card" + index + ".jpg");
		imgLabel[r][c].setIcon(tempImg);
	}

	@Override
	public void guardar(int i, int x) {
		memButtons[i][x].setEnabled(false);
	}
	...
	private class FlipListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			card.jogar(clicked.getRow(), clicked.getColumn());
		}
	}
