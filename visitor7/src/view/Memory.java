...
public class Memory extends JFrame implements Observer {
	...
	@Override
	public void contagemPares(int totalParesEncontrados) {
		JOptionPane.showMessageDialog(null, "Você encontrou " + totalParesEncontrados + " pares");
	}
