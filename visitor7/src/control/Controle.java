...
import visitor.VisitorContarPares;
import visitor.VisitorTrocarImagens;
...
public class Controle {
	...
	public void contarParesCorretos() {
		VisitorContarPares visitorContarPares = new VisitorContarPares();
		this.accept(visitorContarPares);
		int quantidadeParesEncontrados = visitorContarPares.getContCartas() / 2;

		for (Observer obs : obss) {
			obs.contagemPares(quantidadeParesEncontrados);
		}
	}

	public void trocarImagens() {
		VisitorTrocarImagens visitorTrocarImagens = new VisitorTrocarImagens();
		this.accept(visitorTrocarImagens);
	}
