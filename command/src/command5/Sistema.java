		...
		while (true) {
			...
			switch (op) {
			    case 1: // adicionar no carrinho
			    		...
			    		cc.add(m);*/
						commandInvoker.execute(new AdicionarCarrinhoCommand(opMusica, cc));
			    		break;
			    ...
			    case 2:	// listar carrinho 
						...
						commandInvoker.execute(new ListarCarrinhoCommand(cc, obs));
			    		break;
			    ...
			    case 3: // tamanho das musicas
						...
						commandInvoker.execute(new TamanhoMusicaCommand(cc, obs));
			    		break;
			    ...
			    case 4: // preco total
						...
						commandInvoker.execute(new PrecoTotalCommand(cc, obs));
			    		break;
				case 5:
					commandInvoker.undo();
					break;
