...
import abstractfactory4.Controller.Controle;
import abstractfactory4.Controller.Observador;
...
public class TelaPrincipal extends javax.swing.JFrame implements Observador {
    ...
    public TelaPrincipal() {
        ...
        ActionListener selecionaTipoDeCivilizacao = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (rbtGregos.isSelected()) {
                    controle.escolherCivilizacao(rbtGregos.getText());
                } else if (rbtEgipcios.isSelected()) {
                    controle.escolherCivilizacao(rbtEgipcios.getText());
                } else if (rbtChineses.isSelected()) {
                    controle.escolherCivilizacao(rbtChineses.getText());
                }
            }
        };
    ...
    @Override
    public void iniciarJogo(double macas, double lenhas, double pedras, double dinheiro, int round) {
        lbRound.setText("Round: " + round);

        if (round >= 15) {
            dinheiro = (macas + 2 * lenhas + 3 * pedras);
            String descricao = ("Round " + round + ":" +
                    "\n Colheu " + macas + " maças" +
                    "\n Gerou " + lenhas + " lenhas" +
                    "\n Minerou " + pedras + " pedras" +
                    "\n Conseguiu " + dinheiro + "\n");
    ...
    @Override
    public void adicionarColhedor(int populacaoAtual, double dinheiro, int limitePopulacional) {
        lbPopulacaoAtual.setText("População Atual: " + populacaoAtual);
        lbDinheiro.setText("Dinheiro: " + dinheiro);
        lbLimitePopulacional.setText("Limite Populacional: " + limitePopulacional);
    }

    @Override
    public void adicionarLenhador(int populacaoAtual, double dinheiro, int limitePopulacional) {
        lbPopulacaoAtual.setText("População Atual: " + populacaoAtual);
        lbDinheiro.setText("Dinheiro: " + dinheiro);
        lbLimitePopulacional.setText("Limite Populacional: " + limitePopulacional);
    }
    ...
    @Override
    public void adicionarMinerador(int populacaoAtual, double dinheiro, int limitePopulacional) {
        lbPopulacaoAtual.setText("População Atual: " + populacaoAtual);
        lbDinheiro.setText("Dinheiro: " + dinheiro);
        lbLimitePopulacional.setText("Limite Populacional: " + limitePopulacional);
    }
