...
import abstractfactory3.Correio.FactoryCorreio;
import abstractfactory3.Exportacao.FactoryExportar;
...
public class CalculadoraFreteImpl implements CalculadoraFreteControle {
	...
	public void setTipoFrete(String tipoFrete) {
		...
		if (tipoFrete.equals("Correio")) {
			...
			this.freteFactory = new FactoryCorreio();
		} else {
			// criar o concretefactory de exportar para america do norte
			this.freteFactory = new FactoryExportar();
		}
