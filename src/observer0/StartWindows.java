...
public class StartWindows extends JDialog {
	...
	class JDInc extends JDialog implements ObservadorIncrementar {
        ...
        @Override
        public void altereiConta(int conta) {
            jl.setText(conta + "");
        }
	...
	class JDInc2 extends JDialog implements ObservadorIncrementar {
		...
		public void pack() {
			...
			setLocation(x, y);
                        ...
                        final Incrementar inc2 = Incrementar.getInstancia();
                        inc2.addObservador(this);
			campo = new JTextArea(inc2.getConta() + "");
